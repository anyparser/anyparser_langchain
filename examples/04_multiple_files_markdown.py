"""Example: Process multiple files with markdown output."""
...
async def main():
    """Process multiple files with markdown output."""
    api_key = os.getenv("ANYPARSER_API_KEY")
    api_url = os.getenv("ANYPARSER_API_URL")

    # Process multiple files (excluding PNG)
    files = ["docs/sample.pdf", "docs/sample.docx"]
    all_documents = []
